...
#log: <_sre.SRE_Match object; span=(0, 9), match='010-12345'>

print(re.match(r'^\d{3}\-\d{3,8}$', '010299382'))
#log: None
...
m = re.match(r'(\d{3})-(\d{3,8})$', '010-29939992')
print(m.group(0), m.group(1), m.group(2))
#log: 010-29939992 010 29939992
